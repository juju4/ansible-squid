...
describe package('dansguardian'), :if => (os[:family] == 'ubuntu' && os[:release] != '19.10') || os[:family] == 'debian' do
  it { should be_installed }
end

describe service('dansguardian'), :if => (os[:family] == 'ubuntu' && os[:release] != '19.10') || os[:family] == 'debian' do
  it { should be_enabled }
  it { should be_running }
end  

describe file('/usr/sbin/dansguardian'), :if => (os[:family] == 'ubuntu' && os[:release] != '19.10') || os[:family] == 'debian' do
...
describe file('/var/log/dansguardian/access.log'), :if => (os[:family] == 'ubuntu' && os[:release] != '19.10') || os[:family] == 'debian' do
